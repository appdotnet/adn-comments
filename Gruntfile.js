        ...
        dev: {
            options: {
                data: {
                  ...
                  redirect_uri: defaultAppConfig.redirect_uri,
                  client_id: defaultAppConfig.client_id,
                }
            },
            files: {
                '<%= yeoman.app %>/scripts/config/config.js': ['<%= yeoman.app %>/templates/config.js'],
                '<%= yeoman.app %>/auth.html': ['<%= yeoman.app %>/templates/auth.html']
            }
        },
        dist: {
            options: {
                data: {
                  config: JSON.stringify(distAppConfig),
                  redirect_uri: distAppConfig.redirect_uri,
                  client_id: distAppConfig.client_id,
                }
            },
            files: {
                '<%= yeoman.app %>/scripts/config/config.js': ['<%= yeoman.app %>/templates/config.js'],
